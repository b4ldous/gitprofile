...
const CONFIG = {
  github: {
    username: 'baosub', // Your GitHub org/user name. (This is the only required config)
  },
  /**
  ...
  blog: {
    ...
    username: 'baosub', // to hide blog section, keep it empty
    limit: 2, // How many articles to display. Max is 10.
  },
  googleAnalytics: {
    id: 'G-VD2F9S2E1H', // GA3 tracking id/GA4 tag id UA-XXXXXXXXX-X | G-XXXXXXXXXX
  },
